...
//volatile static uint32_t count_new;
static volatile uint32_t count_in;
//volatile static uint32_t out_ptr;
static volatile uint8_t buffer_out[16*CDCACM_PACKET_SIZE];
//volatile static uint8_t double_buffer_out[CDCACM_PACKET_SIZE];
...
{
	(void)ep;
	volatile static uint8_t buf[CDCACM_PACKET_SIZE];
