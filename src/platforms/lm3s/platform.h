...
#define BOARD_IDENT             "Black Magic Probe (LM3S), (Firmware 1.5" VERSION_SUFFIX ", build " BUILDDATE ")"
#define BOARD_IDENT_DFU		"Black Magic (Upgrade) for LM3S, (Firmware 1.5" VERSION_SUFFIX ", build " BUILDDATE ")"
#define DFU_IDENT               "Black Magic Firmware Upgrade (LM3S)"
...
#define LED_PORT	GPIOD_APB_BASE
...
#define USB_DRIVER	lm3s_usb_driver
